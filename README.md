...
Возможности:
* Возможность создавать несколько баннерных галерей.
* Настройка каждой галереи: порядок сортировки баннеров.
* Настройка каждого баннера включает в себя: изобрадение, ссылку, название(title).
